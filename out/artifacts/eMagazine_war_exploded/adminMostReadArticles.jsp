            ...
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=1" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        ...
                        <input name="article1TitleEnglish" id="article1TitleEnglish" type="text" required>
                        <label for="article1TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article1TitleKannada" id="article1TitleKannada" type="text" required>
                ...
                <div class="file-field input-field col s12">
                    <a class="btn" id="article1uploadEnglish" onclick="toggleDisable(this.id,1);"><i
                            class="material-icons left">perm_media</i>Upload File
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=2" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article2TitleEnglish" id="article2TitleEnglish" type="text" required>
                        <label for="article2TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article2TitleKannada" id="article2TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=3" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article3TitleEnglish" id="article3TitleEnglish" type="text" required>
                        <label for="article3TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article3TitleKannada" id="article3TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=4" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article4TitleEnglish" id="article4TitleEnglish" type="text" required>
                        <label for="article4TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article4TitleKannada" id="article4TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=5" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article5TitleEnglish" id="article5TitleEnglish" type="text" required>
                        <label for="article5TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article5TitleKannada" id="article5TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=6" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article6TitleEnglish" id="article6TitleEnglish" type="text" required>
                        <label for="article6TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article6TitleKannada" id="article6TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=7" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article7TitleEnglish" id="article7TitleEnglish" type="text" required>
                        <label for="article7TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article7TitleKannada" id="article7TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=mostReadArticles&number=8" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article8TitleEnglish" id="article8TitleEnglish" type="text" required>
                        <label for="article8TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article8TitleKannada" id="article8TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=9" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article9TitleEnglish" id="article9TitleEnglish" type="text" required>
                        <label for="article9TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article9TitleKannada" id="article9TitleKannada" type="text" required>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&&upload=mostReadArticles&&number=10" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article10TitleEnglish" id="article10TitleEnglish" type="text" required>
                        <label for="article10TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="article10TitleKannada" id="article10TitleKannada" type="text" required>
