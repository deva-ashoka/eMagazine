                    ...
                    if (!fi.isFormField()) {
                        ...
                        if (fileName.intern() != "") {
                            ...
                            if (fileExtension.equals(".jpeg") || fileExtension.equals(".jpg") || fileExtension.equals(".png")) {
                                ...
                                if (db.success.intern() == "success") {
                                    String selectImagePathStatement = "SELECT image_path FROM emagazine.public.other_stories WHERE month = lower(?) AND year = ? AND area = ? AND serial = ? AND status = 'editing';";
