        ...
        if ((contentType.indexOf("multipart/form-data") >= 0)) {
            try {
                        ...
                        if (fileName.intern() != "") {
                            ...
                            if (fileExtension.equals(".jpg") || fileExtension.equals(".jpeg") || fileExtension.equals(".png")) {
                                ...
                                if (db.success.intern() == "success") {
                                    String selectImagePathStatement = "SELECT image_path FROM emagazine.public.events WHERE month = lower(?) AND year = ? AND area = ? AND serial = ? AND status = 'editing';";
                ...
                if (db.success.intern() == "success") {
                    ...
                    //to delete the file already uploaded
                    String selectForPath = "";
