...
<div class="row">
    ...
    <div id="test1" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=1" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 1: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed1TitleEnglish" id="newsfeed1TitleEnglish" type="text" required>
                        <label for="newsfeed1TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed1TitleKannada" id="newsfeed1TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed1Link',1);">
                        ...
                        <input name="newsfeed1Link" id="newsfeed1Link" type="text"
                               onfocus="toggleDisable('newsfeed1Link',1);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed1uploadEnglish" onclick="toggleDisable(this.id,1);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed1uploadKannada" onclick="toggleDisable(this.id,1);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test2" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=2" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 2: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed2TitleEnglish" id="newsfeed2TitleEnglish" type="text" required>
                        <label for="newsfeed2TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed2TitleKannada" id="newsfeed2TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed2Link',2);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed2Link" id="newsfeed2Link" type="text"
                               onfocus="toggleDisable('newsfeed2Link',2);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed2uploadEnglish" onclick="toggleDisable(this.id,2);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed2uploadKannada" onclick="toggleDisable(this.id,2);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test3" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=3" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 3: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed3TitleEnglish" id="newsfeed3TitleEnglish" type="text" required>
                        <label for="newsfeed3TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed3TitleKannada" id="newsfeed3TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed3Link',3);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed3Link" id="newsfeed3Link" type="text"
                               onfocus="toggleDisable('newsfeed3Link',3);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed3uploadEnglish" onclick="toggleDisable(this.id,3);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed3uploadKannada" onclick="toggleDisable(this.id,3);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test4" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=4" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 4: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed4TitleEnglish" id="newsfeed4TitleEnglish" type="text" required>
                        <label for="newsfeed4TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed4TitleKannada" id="newsfeed4TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed4Link',4);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed4Link" id="newsfeed4Link" type="text"
                               onfocus="toggleDisable('newsfeed4Link',4);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed4uploadEnglish" onclick="toggleDisable(this.id,4);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed4uploadKannada" onclick="toggleDisable(this.id,4);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test5" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=5" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 5: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed5TitleEnglish" id="newsfeed5TitleEnglish" type="text" required>
                        <label for="newsfeed5TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed5TitleKannada" id="newsfeed5TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed5Link',5);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed5Link" id="newsfeed5Link" type="text"
                               onfocus="toggleDisable('newsfeed5Link',5);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed5uploadEnglish" onclick="toggleDisable(this.id,5);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed5uploadKannada" onclick="toggleDisable(this.id,5);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test6" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=6" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 6: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed6TitleEnglish" id="newsfeed6TitleEnglish" type="text" required>
                        <label for="newsfeed6TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed6TitleKannada" id="newsfeed6TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed6Link',6);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed6Link" id="newsfeed6Link" type="text"
                               onfocus="toggleDisable('newsfeed6Link',6);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed6uploadEnglish" onclick="toggleDisable(this.id,6);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed6uploadKannada" onclick="toggleDisable(this.id,6);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test7" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=7" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 7: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed7TitleEnglish" id="newsfeed7TitleEnglish" type="text" required>
                        <label for="newsfeed7TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed7TitleKannada" id="newsfeed7TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed7Link',7);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed7Link" id="newsfeed7Link" type="text"
                               onfocus="toggleDisable('newsfeed7Link',7);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed7uploadEnglish" onclick="toggleDisable(this.id,7);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed7uploadKannada" onclick="toggleDisable(this.id,7);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
    ...
    <div id="test8" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=newsFeed&number=8" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> News Feed 8: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed8TitleEnglish" id="newsfeed8TitleEnglish" type="text" required>
                        <label for="newsfeed8TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input name="newsfeed8TitleKannada" id="newsfeed8TitleKannada" type="text" required>
                    ...
                    <div class="input-field col s12" onclick="toggleDisable('newsfeed8Link',8);">
                        <i class="material-icons prefix">language</i>
                        <input name="newsfeed8Link" id="newsfeed8Link" type="text"
                               onfocus="toggleDisable('newsfeed8Link',8);">
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed8uploadEnglish" onclick="toggleDisable(this.id,8);"><i
                                class="material-icons left">perm_media</i>Upload English File
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn" id="newsfeed8uploadKannada" onclick="toggleDisable(this.id,8);"><i
                                class="material-icons left">perm_media</i>Upload Kannada File
