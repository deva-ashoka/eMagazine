...
<div class="row">
    ...
    <div id="test1" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=1" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> Event 1: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event1TitleEnglish" id="event1TitleEnglish" type="text">
                        <label for="event1TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event1TitleKannada" id="event1TitleKannada" type="text">
                        <label for="event1TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event1ContentEnglish"
                                  id="event1ContentEnglish"
                                  type="text"></textarea>
                        <label for="event1ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event1ContentKannada"
                                  id="event1ContentKannada"
                                  type="text"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="event1Image" type="file">
                        </a>
    ...
    <div id="test2" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=2" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> Event 2: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event2TitleEnglish" id="event2TitleEnglish" type="text">
                        <label for="event2TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event2TitleKannada" id="event2TitleKannada" type="text">
                        <label for="event2TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event2ContentEnglish"
                                  id="event2ContentEnglish"
                                  type="text"></textarea>
                        <label for="event2ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event2ContentKannada"
                                  id="event2ContentKannada"
                                  type="text"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="event2Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
    ...
    <div id="test3" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=3" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> Event 3: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event3TitleEnglish" id="event3TitleEnglish" type="text">
                        <label for="event3TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event3TitleKannada" id="event3TitleKannada" type="text">
                        <label for="event3TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event3ContentEnglish"
                                  id="event3ContentEnglish"
                                  type="text"></textarea>
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event3ContentKannada"
                                  id="event3ContentKannada"
                                  type="text"></textarea>
                        <label for="event1ContentKannada">Content in Kannada</label>
                    </div>
                    <br/><br/>
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="event3Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
    ...
    <div id="test4" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=4" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> Event 4: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event4TitleEnglish" id="event4TitleEnglish" type="text">
                        <label for="event4TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event4TitleKannada" id="event4TitleKannada" type="text">
                        <label for="event4TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event4ContentEnglish"
                                  id="event4ContentEnglish"
                                  type="text"></textarea>
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event4ContentKannada"
                                  id="event4ContentKannada"
                                  type="text"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="event4Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
    ...
    <div id="test5" class="col s12">
        <br/><br/>
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=event&number=5" method="post"
                  enctype="multipart/form-data">
                <div class="row">
                    <span style="font-size: 1.5em;"> Event 5: </span> <br/>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event5TitleEnglish" id="event5TitleEnglish" type="text">
                        <label for="event5TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="event5TitleKannada" id="event5TitleKannada" type="text">
                        <label for="event5TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required class="materialize-textarea" name="event5ContentEnglish"
                                  id="event5ContentEnglish"
                                  type="text"></textarea>
                        <label for="event5ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required placeholder="Content in Kannada" name="event5ContentKannada"
                                  id="event5ContentKannada"
                                  type="text"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="event5Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
