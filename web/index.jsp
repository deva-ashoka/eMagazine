        ...
        <div class="row">
            ...
            <div id="event_modal" class="modal modal-fixed-footer " style="width:70%; ">
                <div class="modal-content">
                    ...
                    <p>
                        <img id="event_modal_image" src="http://materializecss.com/images/sample-1.jpg"
        ...
        <div class="col s12 m9">
            <div class="row">
                ...
                <div class="col s12 m7"><br>
                    ...
                    <p><a class="waves-effect waves-light" href="otherStories.jsp">MORE STORIES</a></p>
                    <!--Modal for story 3-->
            ...
            <div class="row">
                ...
                <ul class="collapsible pull-l1" data-collapsible="accordion">
                    ...
                    <li>
                        <div class="collapsible-header"><i class="material-icons dp48 teal-dark">info</i>Bizarre news
                        </div>
                        <div class="collapsible-body">
                            <p>1.<a href="" id="miscellaneous3_link"><span
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <p>1.<a href="" id="miscellaneous4_link"><span
                                    id="miscellaneous4_title"><!--content--></span></a></p>
