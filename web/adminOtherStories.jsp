            ...
            <form action="controller.jsp?requestFor=upload&upload=stories&number=1" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        ...
                        <input required name="story1TitleEnglish" id="story1TitleEnglish" type="text">
                        <label for="story1TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story1TitleKannada" id="story1TitleKannada" type="text">
                        <label for="story1TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required id="story1ContentEnglish" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                        <label for="story1ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story1ContentKannada" id="story1ContentKannada" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="story1Image" type="file">
                        </a>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=stories&number=2" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story2TitleEnglish" id="story2TitleEnglish" type="text">
                        <label for="story2TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story2TitleKannada" id="story2TitleKannada" type="text">
                        <label for="story2TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story2ContentEnglish" id="story2ContentEnglish" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                        <label for="story2ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story2ContentKannada" id="story2ContentKannada" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="story2Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=stories&number=3" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story3TitleEnglish" id="story3TitleEnglish" type="text">
                        <label for="story3TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story3TitleKannada" id="story3TitleKannada" type="text">
                        <label for="story3TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story3ContentEnglish" id="story3ContentEnglish" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                        <label for="story3ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story3ContentKannada" id="story3ContentKannada" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="story3Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=stories&number=4" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story4TitleEnglish" id="story4TitleEnglish" type="text">
                        <label for="story4TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story4TitleKannada" id="story4TitleKannada" type="text">
                        <label for="story4TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story4ContentEnglish" id="story4ContentEnglish" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                        <label for="story4ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story4ContentKannada" id="story4ContentKannada" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="story4Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
        ...
        <div class="container">
            <form action="controller.jsp?requestFor=upload&upload=stories&number=5" method="post"
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story5TitleEnglish" id="story5TitleEnglish" type="text">
                        <label for="story5TitleEnglish">Title in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">label</i>
                        <input required name="story5TitleKannada" id="story5TitleKannada" type="text">
                        <label for="story5TitleKannada">Title in Kannada</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story5ContentEnglish" id="story5ContentEnglish" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                        <label for="story5ContentEnglish">Content in English</label>
                    </div>
                    <div class="input-field col s12">
                        <i class="material-icons prefix">subject</i>
                        <textarea required name="story5ContentKannada" id="story5ContentKannada" minlength="100"
                                  type="text" class="materialize-textarea"></textarea>
                    ...
                    <div class="file-field input-field col s12">
                        <a class="btn"><i class="material-icons left">perm_media</i>Upload Image
                            <input required name="story5Image" type="file">
                        </a>
                        <div class="file-path-wrapper">
                            <input required class="file-path validate" type="text">
                        </div>
